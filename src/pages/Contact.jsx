        ...
        <div className="container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full">
          <div className="flex flex-col w-full max-w-[780px]">
            ...
            >
              ...
              <button className="btn rounded-full backdrop-blur-sm border z-50 border-black/50 max-w-[170px] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-accent group hover:animate-pulse">
